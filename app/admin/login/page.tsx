...
export default function AdminLogin(){
  ...
  const [email,setEmail]=useState('Aolanmachinery@gmail.com'),[password,setPassword]=useState(''),[message,setMessage]=useState(''),[busy,setBusy]=useState(false);
  ...
  return <main className="min-h-screen bg-[#f3f5f2] px-5 pt-32">
    <section className="mx-auto max-w-md rounded-3xl bg-white p-8 shadow-xl">
      ...
      <h1 className="mt-5 text-3xl font-black">AOLAN Admin Login</h1>
