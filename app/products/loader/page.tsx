...
export const metadata:Metadata={title:{absolute:'XCMG Loaders for Sale | AOLAN Machinery'},description:'Find XCMG wheel loaders, skid steer loaders and backhoe loaders for construction, mining, agriculture and road projects.',alternates:{canonical:'/products/loader'}};
