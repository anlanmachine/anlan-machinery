...
export const metadata:Metadata={title:{absolute:'Forklifts for Sale | AOLAN Machinery'},description:'Browse forklift sourcing options for warehouse, container loading, factory and construction material handling projects.',alternates:{canonical:'/products/forklift'}};
