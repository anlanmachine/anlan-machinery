...
export const metadata:Metadata={title:{absolute:'XCMG Motor Graders for Sale | AOLAN Machinery'},description:'Discover XCMG motor graders for road construction, land leveling and infrastructure projects.',alternates:{canonical:'/products/motor-grader'}};
