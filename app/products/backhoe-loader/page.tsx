...
export const metadata:Metadata={
  title:{absolute:'XCMG Backhoe Loaders for Sale | AOLAN Machinery'},
...
export default async function BackhoeLoaderPage(){
  ...
  return <section className="section pt-36"><div className="wrap">
    <p className="eyebrow">New machinery catalog</p><h1 className="title mt-3">XCMG Backhoe Loaders</h1><p className="sub mt-5">Compare backhoe loader machines with local photos, model data and export quotation support from AOLAN Machinery.</p>
