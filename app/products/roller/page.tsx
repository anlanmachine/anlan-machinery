...
export const metadata:Metadata={title:{absolute:'XCMG Road Rollers for Sale | AOLAN Machinery'},description:'Browse XCMG single drum rollers and pneumatic rollers for road construction, compaction and earthwork projects.',alternates:{canonical:'/products/roller'}};
