...
export const metadata:Metadata={title:{absolute:'XCMG Excavators for Sale | AOLAN Machinery'},description:'Explore new XCMG crawler excavators, mini excavators and wheel excavators with reliable performance, competitive pricing and export support.',alternates:{canonical:'/products/excavator'}};
