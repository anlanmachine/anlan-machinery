...
export const metadata:Metadata={title:{absolute:'Self Loading Concrete Mixers for Sale | AOLAN Machinery'},description:'View self loading concrete mixers with reliable mixing, loading and transport functions for construction sites.',alternates:{canonical:'/products/concrete-mixer'}};
